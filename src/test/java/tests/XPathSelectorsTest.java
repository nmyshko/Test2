...
public class XPathSelectorsTest {
    ...
    public void xpathLocatorsTest() {
        ...
        // - элемент может находится на любом уровне
        //Абсолютный XPath (не использовать)
        Assert.assertEquals(128, driver.findElements(By.xpath("/html/head/style/text()")).size());
...
// Поиск элемента у которого значение аттрибута содержит подстроку
        ...
        // Поиск элемента по индексу (стараться не использовать)
